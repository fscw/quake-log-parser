...
const (
	...
	MOD_TARGET_LASER
	MOD_TRIGGER_HURT
	MOD_NAIL           // mission pack
	MOD_CHAINGUN       // mission pack
	MOD_PROXIMITY_MINE // mission pack
	MOD_KAMIKAZE       // mission pack
	MOD_JUICED         // mission pack
	MOD_GRAPPLE
)

var MeansOfDeath = map[int]string{
	...
	MOD_NAIL:           "MOD_NAIL",           // mission pack
	MOD_CHAINGUN:       "MOD_CHAINGUN",       // mission pack
	MOD_PROXIMITY_MINE: "MOD_PROXIMITY_MINE", // mission pack
	MOD_KAMIKAZE:       "MOD_KAMIKAZE",       // mission pack
	MOD_JUICED:         "MOD_JUICED",         // mission pack
